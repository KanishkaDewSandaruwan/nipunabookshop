		 ...
		 ?>
			<div class="carousel-inner" role="listbox">
			    ...
			    <div class="carousel-item active">
			      	...
			      	<div class="view">
			        	<img class="d-block w-100" style="width: 100%; height: 600px" src="<?php echo $image_src1; ?>" alt="First slide">
			        	<div class="mask rgba-black-light"></div>
			      	</div>

			      	<div class="carousel-caption">
			        	<h3 class="h3-responsive"><?php echo $row['title']; ?></h3>
			    ...
			    <!--Mask color-->
					...
					<div class="view">
				        <img class="d-block w-100" style="width: 100%; height: 600px" src="<?php echo $image_src2; ?>" alt="Second slide">
			    ...
			    <div class="carousel-item">
			      <!--Mask color-->
			    	...
			    	<div class="view">
			        	<img class="d-block w-100" style="width: 100%; height: 600px" src="<?php echo $image_src3; ?>" alt="Third slide">
