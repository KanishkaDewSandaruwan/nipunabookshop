...
<body>
	...
	<div class="row p-5">
        ...
        <div class="col-md-4 p-1">
          <div class="row mb-5"  style=" padding-left: 5%;">
            <h1 style="color: black"><b>Order Summery</b></h1>
          </div>
          ...
          <div class="row mt-5 justify-content-center">
                <button class="btn btn-info col-sm-11 ml-1" name="" onclick="placeOrder();" type="submit" style="background-color: #000; padding: 3%;">PLACE ORDER</i></button>
          </div>
        </div>
    </div>
    </br>
    <script type="text/javascript">
      ...
      if (payment == "COD"){
          window.location.href='setOrder.php?total=<?php echo $total; ?>';
       }
      }
    </script>
</div>
